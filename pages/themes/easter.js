  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Här kan du se olika exempel på nagel-, hår- och sminkstilar med påsk tema som jag har gjort | Here you can see different examples of easter themed nail,hair and makeup styles that I have done."
        />
      </Head>
